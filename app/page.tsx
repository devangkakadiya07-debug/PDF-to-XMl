...
import DeferredDocumentationExamples from '@/components/DeferredDocumentationExamples';
      ...
      <section id="documentation" className="bg-zinc-50 py-20">
        <div className="mx-auto w-full max-w-6xl px-6">
          <div className="grid items-start gap-10 lg:grid-cols-12">
            <div className="min-w-0 space-y-8 lg:col-span-5 xl:col-span-5">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-zinc-400">
                  Documentation
                </p>
            ...
            <div className="min-w-0 lg:col-span-7 xl:col-span-7 lg:sticky lg:top-24">
              <DeferredDocumentationExamples />
            </div>
          </div>
        </div>
      </section>
