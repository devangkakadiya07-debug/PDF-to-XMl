    ...
    <main className="bg-white">
      <div className="mx-auto w-full max-w-3xl px-6 py-16">
        <div className="prose prose-zinc">
          ...
          <p>
            These Terms of Service govern your access to and use of UBL API, a B2B API for
            converting JSON to EN16931 UBL 2.1 XML.
          </p>
          ...
          <p>
            ...
            government gateways such as Peppol or XRechnung. We are not liable for rejected
            invoices, penalties, or tax assessments arising from your use of the service.
          </p>

          <h2>Abuse and Prohibited Activities</h2>
          <p>
            Reverse engineering the API, attempting to bypass rate limits, or using the service
            for illegal activities will result in immediate account termination.
          </p>
